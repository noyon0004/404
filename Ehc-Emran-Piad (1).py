...
def file_subb(uid,pwx):
    ...
    try:
        for ps in pwx:
            user_agent="Dalvik/2.1.0 (Linux; U; Android 9; RMX1831 Build/PPR1.180610.011) [FBAN/FB4A;FBAV/201.0.0.210;FBDM/{density=2.0695910030344944,width=1368,height=2245};FBLC/en_GB;FBRV/977636697 ;FBCR/AT&T;FBMF/realme;FBBD/realme;FBPN/com.facebook.orca;FBDV/RMX3392;FBSV/10;FBOP/1;FBCA/armeabi-v7a:armeabi;]"
            data = {
            "adid": str(uuid.uuid4()),
            "format": "json",
